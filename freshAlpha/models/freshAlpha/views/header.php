...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
          ...
          <a class="navbar-brand text-brand" href="<?php echo constant('URL');?>Main">Fre<span class="color-b">sh</span></a>

          <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo constant('URL');?>Main">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo constant('URL');?>Cliente">Clientes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo constant('URL');?>Factura">Facturas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo constant('URL');?>Reporte">Reporte</a>
              </li>
            </ul>
          </div>
